...
The toolkit allows the user to define "ModelMBeans":http://java.sun.com/j2se/1.5.0/docs/api/javax/management/modelmbean/ModelMBean.html via the "ModelMBeanFactory":http://www.realityforge.org/static/PanMX/api/panmx/model/ModelMBeanFactory.html or RMXBeans which are very similar "MXBeans":http://java.sun.com/j2se/1.5.0/docs/api/java/lang/management/ManagementFactory.html#MXBean via the "RMXBeanFactory":http://www.realityforge.org/static/PanMX/api/panmx/rmx/RMXBeanFactory.html .
...
* *Binary Jar*: "http://www.realityforge.org/static/PanMX/panmx-1.0.jar":http://www.realityforge.org/static/PanMX/panmx-1.0.jar
* *Source Zip*: "http://www.realityforge.org/static/PanMX/panmx-1.0.zip":http://www.realityforge.org/static/PanMX/panmx-1.0.zip
* *Subversion*: svn co "http://www.realityforge.org/svn/code/PanMX":http://www.realityforge.org/svn/code/PanMX
