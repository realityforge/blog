...
---
I needed to host photos from a recent trip to New Zealand. I started modifying "eyelook":http://www.realityforge.org/articles/2006/04/21/eyelook-rails-photo-gallery to make it easier to do what I wanted such as geocoding, bulk upload, hierarchial grouping, different sizes, different layouts, themes etc. It was taking a bit of time so I decided to look around at existing services but none of them suited my needs. 
