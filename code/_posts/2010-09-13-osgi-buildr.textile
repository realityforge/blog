...
The following @buildfile@ demonstrates how to build the bundle using the buildr-bnd extension and download an extension from a maven 2 repository.
...
The source for the example can be found at "http://github.com/realityforge/buildr-examples/tree/master/bnd-helloworld/":http://github.com/realityforge/buildr-examples/tree/master/bnd-helloworld/. To build the project you will need to install ruby or jruby, "buildr":http://buildr.apache.org/ and the "build-bnd":http://github.com/realityforge/buildr-bnd gem.

h3. Deploying the bundle
